        ...
        <div className="info-wrapper">
          <div className="left-wrap">
            <div className="info-wrap">
              ...
              <div className="desc">
                <p>
                  I’m a full-stack web developer always looking for an
                  opportunity to solve problems, learn, and grow in a positive
                  environment with motivated, supportive people.
                </p>
            ...
            <div className="showcase-wrap">
              ...
              <div className="text">
                ...
                <p className="desc">
                  ...
                  CSS, JavaScript, Nunjucks, SASS, JSON, jQuery and Gulp
                  building the login, registration and success pages for
                  sponsors of Shell like Bank of America, Reddit, Sonesta, Red
                  Bull, Dunkin Donuts, CarAdvise, American Airlines, and many
                  more. This project includes several technologies such as:
                </p>
                <ul>
            ...
            <div className="projects-wrap">
              <div className="showcase-wrap">
                ...
                <div className="text">
                  ...
                  <p className="desc">
                    BlogLab is my current personal project that I'm building
                    where a user will be able to post, edit and share blogs,
                    listings, podcasts, guides and more. This project includes:
                  </p>
                  Current features:
                  <ul>
              ...
              <div className="showcase-wrap">
                ...
                <div className="text">
                  ...
                  <p className="desc">
                    ...
                    buisiness; customer/employee relations. It is a fully
                    RESTful design that includes:
                  </p>
                  <ul>
                    <li>Landing page</li>
                    <li>Login functionality</li>
              ...
              <div className="showcase-wrap">
                ...
                <div className="text">
                  ...
                  <p className="desc">
                    When he was 9 years old, Andy Fancher, found WWII
                    memorabilia that inspired him to know more, but little to no
                    information was known about the veterans he found. It later
                    inspired him to go on a mission to find the untold stories
                    of these heroes so the world could better know them in what
                    became Andy Fancher Presents. On this platform, he could
                    document these stories for the world to see and hear for
                    themselves.
                  </p>
                  <p className="desc">
                    His journey inspired me, knowing that so many amazing
                    stories have been lost over time, so I used how I could help
                    to design this website for him in hopes it could help his
