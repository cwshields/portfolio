        ...
        <div className="showcase-wrap">
          ...
          <div className="text">
            ...
            <p className="desc">His journey inspired me knowing that so many amazing stories have been lost over time, so I used how I 
              could help to design this website for him in hopes it could help his journey be successful.</p>
          </div>
        </div>
        <div className="showcase-wrap">
          ...
          <div className="text">
            <h1>Drino</h1>
            <p className="desc">This was a full-stack project I worked on for both sides of a buisiness. It is a fully RESTful design 
              that includes data statistic capabilities, a customizable profile for employees, a fully working contact form along with
              a inbox for messages, and a editable list of employees.</p>
          </div>
        </div>
      </div>
    </div>
