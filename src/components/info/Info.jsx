    ...
    <div className="page-wrap">
      <div className="left-wrap">
        <div className="info-wrap">
          <div className="info">
            ...
            <div className="egg1">don't click me...</div>
          ...
          <div className="desc-wrap">
            <div className="desc">
              I’m a full-stack web developer always looking for an opportunity to
              solve problems, learn, and grow in a positive environment with
              motivated, supportive people.
            </div>
          </div>
          <a href="/" className="project-link">
            <svg
              ...
              >
                <path
                  d="m32 8c-1.104 0-2 .896-2 2v39.899l-14.552-15.278c-.761-.799-2.026-.832-2.828-.069-.8.762-.831 2.027-.069 2.827l16.62 17.449c.756.756 
                1.76 1.172 2.829 1.172 1.068 0 2.073-.416 2.862-1.207l16.586-17.414c.762-.8.73-2.065-.069-2.827-.799-.763-2.065-.731-2.827.069l-14.552 
                15.342v-39.963c0-1.104-.896-2-2-2z"
                />
              </svg>
      ...
      <div className="stack-wrap">
        <div className="frameworks-wrap">
          <div className="fw stack-sect">frameworks</div>
        ...
        <div className="libraries-wrap">
          <div className="lib stack-sect">libraries</div>
          <img className="bootstrap logo" src={bootstrap} alt="bootstrap-logo.png"/>
          <img className="sass logo" src={sass} alt="sass-logo.png"/>
        </div>
        <div className="fundamentals-wrap">
          <div className="funds stack-sect">fundamentals</div>
